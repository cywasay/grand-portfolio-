        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-md text-lg lg:text-xl text-[#1A1A23]/80 dark:text-muted-foreground font-medium">
              Like a true Swiss Army knife, I help companies develop their brand
              by offering a complete artistic vision and a wide range of
              expertise.
            </p>
          </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg lg:max-w-xl">
              ...
              <Image
                src="/hero-image.png"
                alt="Isometric Analysis Illustration"
                width={600}
                height={700}
